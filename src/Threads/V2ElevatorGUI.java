...
public class V2ElevatorGUI {
    ...
    public void highlightBox(int FloorNum, int ElevatorNum, Color color) {
        ...
        if (FloorNum < 1 || FloorNum > 22 || ElevatorNum < 1 || ElevatorNum > 4) {
            throw new IllegalArgumentException("Invalid FloorNum or column number");
        }
    ...
    public static void main(String[] args) {
        V2ElevatorGUI gui = new V2ElevatorGUI();
        // Example usage: highlight boxes in rows 5 and 8, columns 2 and 4 with red color
